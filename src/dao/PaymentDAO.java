...
public class PaymentDAO {
    ...
    public void addPayment(Payment p) {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            pst.executeUpdate();
            System.out.println("Payment details are Added");
        } catch (Exception e) {
    ...
    public void updatePaymentStatus(int payment_id, String status) {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            if (rows > 0) System.out.println("Payment Status Updated successfully");
    ...
    public void deletePayment(int payment_id) 
    {
             ...
             PreparedStatement pst = conn.prepareStatement(sql)) 
        {
            ...
            int rows = pst.executeUpdate();
            if (rows > 0) System.out.println("Payment Deleted successfully");
            else System.out.println("Payment not found");
        } 
        catch (Exception e) {
            System.out.println(e);
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            if (rs.next()) {
                return new Payment(rs.getInt("payment_id"),
                      rs.getInt("courier_id"), rs.getDouble("amount"), rs.getString("mode"),
                      rs.getString("status"));
            }
        } catch (Exception e) 
        {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            while (rs.next()) {
                list.add(new Payment(rs.getInt("payment_id"),
                 rs.getInt("courier_id"), rs.getDouble("amount"),
